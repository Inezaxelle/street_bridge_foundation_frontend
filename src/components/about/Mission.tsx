  ...
  return (
    <div className="bg-[#082244] py-8 lg:px-24 px-6 pb-12">
      ...
      <div className="md:flex">
        <img src={logo} alt="sbf logo" className="w-1/2 bg-white h-[522px] md:block hidden"/>
        <p className="md:w-1/2 bg-[#F9F5E8] text-[#082244] flex justify-center pt-14 my-6 px-6 mb:pb-0 pb-6">
